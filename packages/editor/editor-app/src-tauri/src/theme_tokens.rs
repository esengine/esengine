...
/// Embedded default theme json for egui desktop; kept in sync with `src/styles/design-tokens.json`.
pub const DEFAULT_THEME_JSON: &str = include_str!("../../src/styles/design-tokens.json");
